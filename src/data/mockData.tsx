...
> BNK경남은행, IBK기업은행 등 금융권 다수 SI 프로젝트에서 Java/Spring  기반 배치 시스템과 EAI 연계 시스템을 설계·구축해왔습니다.
> 일 최대 수백만 건 규모의 거래 데이터를 처리하는 배치 로직과, 위성시스템 - 채널시스템 간 60여종 연계 인터페이스를 통해 데이터 정합성을 보장하는 경험을 쌓았습니다.
