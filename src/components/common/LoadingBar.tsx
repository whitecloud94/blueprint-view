...
export const LoadingBar = () => {
    return (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-[#F3F3F3]/50 dark:bg-[#121212]/60 backdrop-blur-sm">
                ...
                >
                    ...
                    <div className="w-full space-y-3">
                        <div className="flex justify-between items-end">
                            <span className="text-sm font-black text-gray-900 dark:text-white tracking-tight uppercase italic">
                                Loading
                            </span>
                            <motion.span
                        ...
                        <div className="h-1.5 w-full bg-gray-200/50 dark:bg-white/10 rounded-full overflow-hidden">
                            <motion.div
                                initial={{ x: "-100%" }}
                                animate={{ x: "100%" }}
                                transition={{
                    ...
                    <p className="text-[12px] text-gray-400 dark:text-gray-500 font-medium text-center">
